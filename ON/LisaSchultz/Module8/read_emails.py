import imaplib
import getpass
import email    #library for mapping and parsing email messages

#connection info
imap_host = 'imap.gmail.com'
user = 'lisa.r.schultz5122@gmail.com'
port = 993
...
try:
    ...
    mail.select('inbox')
    #return status msg, return list of how many emails in the mailbox
