...
sender = 'lisa.r.schultz5122@gmail.com'
recipient = 'lisa.r.schultz5122@gmail.com'
#this allows you to type the password without showing
...
try:
    ...
    smtp_obj.ehlo()
    #if you use port 465 (SSL), encryption is already set up. No need to call startls()
