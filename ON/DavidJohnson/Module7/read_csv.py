...
def max_rate():
    ...
    for i in range(1, len(file_data)):
        # compare each value 1 by 1 from the first to last
...
if __name__ == "__main__":
    ...
    n, d, j, m = max_rate()
    print("\nInformation of the highest-rated employee:\n")
    print("Name: {}\nDepartment: {}\nJob Title: {}\nHourly Rate: {}\n".format(n, d, j, m))
    # (words, count, round(percent, 2)) returned from search_job_titles()
    w, c, p = search_job_titles('tech')
    print("Lowest hourly rate found on Seattle Database: ", low_rate())
...
# print(file_data[1])
# # print only the last column header
# print(file_data[0][4])